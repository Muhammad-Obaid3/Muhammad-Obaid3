...
- **Modern Scalable Applications** using **.NET**, **ReactJS**, **Azure**, and **CI/CD pipelines**
...
Unity, C#, C++, .NET, GLTF, Firebase, Android, iOS

**Frontend Development:**  
HTML, CSS, Bootstrap, Tailwind, ReactJS, Next.js

**Data & AI:**  
Hadoop, Hive, Zeppelin, HDFS, Protégé, Prolog

**DevOps & Cloud:**  
Azure, GitHub Actions, Docker, Kubernetes, CI/CD, FileZilla, PuTTY

**Collaboration & Project Management:**  
Git (GitHub, GitLab, Bitbucket), Trello, Jira, Agile & Scrum
